...
type locustStats struct {
	...
	CurrentResponseTimePercentiles struct {
		...
		CurrentResponseTimePercentileNinetieth float64 `json:"response_time_percentile_0.90"`
...
func (e *Exporter) scrape(ch chan<- prometheus.Metric) (up float64) {
	...
	ch <- prometheus.MustNewConstMetric(e.locustCurrentResponseTimePercentileNinetieth.Desc(),prometheus.GaugeValue,float64(locustStats.CurrentResponseTimePercentiles.CurrentResponseTimePercentileNinetieth))
